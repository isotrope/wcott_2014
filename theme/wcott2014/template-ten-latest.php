<?php
/*
 * Template Name: 10 latest posts
 * Description: Page template that displays the 10 latest posts
 */
get_header();
?>
...
<div id="primary" class="content-area">
    <main id="main" class="site-main" role="main">
        ...
        <?php endwhile; // end of the loop. ?>
            <div class="demo-step-togglers">
                <a href="#" id="btn-add-step">Toggle Step</a>
            </div>
        <?php
        ...
        <?php if ( $the_query->have_posts() ) : ?>
            <section class="section-ten-latest-posts">

            <!-- the loop -->
            <?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
            <?php
            $post_class = array('ten-latest-posts');
